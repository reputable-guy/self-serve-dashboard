...
// Mock studies for this brand - diverse categories
const mockBrandStudies = [
  {
    id: "study-1",
    name: "SleepWell Premium",
    category: "sleep", // Tier 1
    categoryLabel: "Sleep",
    status: "active",
    participants: 45,
